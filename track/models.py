...
class Track(models.Model):
    ...
    #votes   
    sum_positivity = models.IntegerField(default=4)
    sum_aggression = models.IntegerField(default=4)
    sum_speed      = models.IntegerField(default=4)
    sum_suspense   = models.IntegerField(default=4)
...
class TrackVote(models.Model):
    ...
    This table is wiped once a week
    '''
    track = models.ForeignKey('track.Track')
    user  = models.ForeignKey('auth.User')
    
    def __unicode__(self):
        return unicode(self.user) + u' voted on ' + unicode(self.track)    
